...
// (GET /admin/price-plan[/{id}]/resource-types → BillingResourceService.getBillingResourceTypes):
// the form picks a resourceType then filters/prices on its attributes. Order is stable for the UI.
